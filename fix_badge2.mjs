...
// Once eski rozet blogunu kaldir
content = content.replace(/\n\n\s+\{\/\* Dogrulama rozeti[\s\S]*?\}\s*\)\}`/m, "")

// TrustScoreRing'i sarmalayan div ile degistir
content = content.replace(
...
console.log("TrustScoreRing sarmalandi mi:", content.includes("flex flex-col items-center gap-1.5"))