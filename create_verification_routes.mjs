...
const routes = `import { PrismaClient } from '@prisma/client'
...
writeFileSync("C:/Users/PC/Desktop/tecrubelerim/src/routes/verificationRoutes.js", routes, "utf8")
console.log("verificationRoutes.js olusturuldu!")